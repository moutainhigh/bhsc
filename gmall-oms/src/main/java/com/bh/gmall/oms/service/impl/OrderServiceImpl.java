package com.bh.gmall.oms.service.impl;
...
import com.bh.gmall.cart.service.CartService;
import com.bh.gmall.cart.vo.CartItem;

import com.bh.gmall.constant.OrderStatusEnum;
import com.bh.gmall.constant.SysCacheConstant;
import com.bh.gmall.oms.component.MemberComponent;

import com.bh.gmall.oms.entity.Order;
import com.bh.gmall.oms.entity.OrderItem;
import com.bh.gmall.oms.mapper.OrderItemMapper;
import com.bh.gmall.oms.mapper.OrderMapper;
...
import com.bh.gmall.ums.service.MemberService;
...
public class OrderServiceImpl extends ServiceImpl<OrderMapper, Order> implements OrderService {
    ...
    public OrderCreateVo createOrder(BigDecimal frontTotalPrice, Long addressId, String note) {
         ...
         */
        String orderToken = RpcContext.getContext().getAttachment("·");
...
//
//        //调用支付宝的支付方法，会返回一个支付页
//        String result = payOrder(orderSn, order.getTotalAmount().toString(), "【分布式商城】-" + productName, body.toString());
//        return result;
//    }
//
//    @Override
