package com.bh.gmall.cart.service.impl;

import com.alibaba.dubbo.config.annotation.Reference;
import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.TypeReference;
import com.bh.gmall.cart.component.MemberComponent;
import com.bh.gmall.cart.service.CartService;
import com.bh.gmall.cart.vo.Cart;
import com.bh.gmall.cart.vo.CartItem;
import com.bh.gmall.cart.vo.CartResponse;
import com.bh.gmall.cart.vo.UserCartKey;
import com.bh.gmall.constant.CartConstant;
...
public class CartServiceImpl implements CartService {
    ...
    public CartResponse checkCartItems(String skuIds, Integer ops, String cartKey, String accessToken) {
        ...
        //修改checked集合的状态
        //2、为了快速找到那个被选中了，我们单独维护了数组  数组在map中用的key 是checked   值是Set集合最好
